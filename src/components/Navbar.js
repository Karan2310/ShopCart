          ...
          <div className="flex md:order-2">
            ...
            <div className="relative hidden lg:block ">
              ...
              <input
                ...
                type="text"
                id="search-navbar"
                className="block w-full p-2 pl-10 text-sm text-gray-900 border border-gray-200 rounded-full bg-gray-200 focus:ring-green-900 focus:border-green-900 outline-none placeholder:text-gray-4000 "
              />
            </div>

            <div className=" items-center mx-3 ms-6 hidden md:flex">
              <i className="fa-regular fa-user me-2"></i>
              <a
                href="#"
                className="py-2 pl-3 pr-4 text-white bg-green-00 rounded md:bg-transparent md:text-black md:p-0 flex items-center"
                aria-current="page"
              >
                Account
              </a>
          ...
          >
            ...
            <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
              ...
              <li>
                <a
                  href="#"
                  className="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-green-700 md:p-0 dark:text-white md:dark:hover:text-green-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700"
                >
                  What's New
                </a>
              </li>
